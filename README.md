...
- **bri-nozero{,-watcher}** watches and resists setting zero brightness
...
- **poormans, kmsccon-wrapper** -- attempt of tolerable work environment without an X server.
- **ext/pdfunite-with-bookmarks** merges pdfs and preserves chapters (code from SO, not mine).

# Things are broken
Many of the scripts have a specific configuration or are tied to my configuration / env variables / file structure. Still, you can create issues, if that would make it better for everyone.
